defmodule Hangman.Impl.Game do 
  ...
  defp score_guess(game, _good_guess = true) do
    # if game.letters is subset of game.used -> :won, else return :good_guess
  ...
  defp score_guess(game = %{ turns_left: 1 }, _good_guess) do
    # if turns_left = 1 -> :lost, else return :bad_guess, decr turns_left
    %{ game | turns_left: (game.turns_left - 1), game_state: :lost } 
  end
